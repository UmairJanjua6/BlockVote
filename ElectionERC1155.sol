...
contract Election is ERC1155("BlockVote Token"){
    ...
    modifier onlyOwner() {
      ...
      _;
        ...
        /**
     * structure that hold Voter information
     **/
        struct Voter {
            string voterName;
            uint256 cnic;
     ...
     **/
        ...
        mapping (uint256 => CandidateStruct []) candidateList;
        
        /**
     * Function to add Candidate into 'candidate List'
     **/
        function addCandidate(uint256 _consNum, address _candidateAddress, string memory _name) public onlyOwner returns(bool) {
            candidateList[_consNum].push(CandidateStruct(_candidateAddress, _name));
            emit addCandidateEvent(_consNum, _candidateAddress, _name);
            return true;
        }
    ...
    **/
        function getCandidatesInConsi(uint256 _consNum) public view returns(CandidateStruct[] memory) {
     ...
     **/
        function deleteConsi(uint256 _consNum) public onlyOwner returns (bool) {
            delete candidateList[_consNum];
            return true;
        }
